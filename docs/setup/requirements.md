...
<table aria-label="4-by-3 table for operating system, CPU, GPU, and RAM requirements">
 ...
 <tbody>
  <tr>
   ...
   <td>
    <ul aria-label="Recommended operating system requirements">
     <li>Windows 11</li>
     <li>macOS 26 (Sonoma–Sequoia)</li>
  ...
  <tr>
   ...
   <td>
    <ul aria-label="Minimum GPU requirements">
     ...
     <li>[PassMark G3D Mark rating](https://www.videocardbenchmark.net/high_end_gpus.html) ≥ 500[^GPU_relevance]</li>
    </ul>
   </td>
   <td>
